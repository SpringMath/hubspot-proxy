...
1. Read [deployment and credential instructions](docs/deployment.md).
...
unrestricted upstream token is permitted. See the [contract audit](docs/client-contract-audit.md).
